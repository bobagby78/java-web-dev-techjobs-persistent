...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        if (existingUser != null){
            errors.rejectValue("username", "username.alreadyExists", "Sorry, that username has already been registered"); //errorCode parameter creates new errors in Errors with a new defaultMessage to show user
            model.addAttribute("title", "Register");
            return "register";
        }
